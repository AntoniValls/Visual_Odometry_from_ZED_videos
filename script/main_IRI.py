...
if __name__ == '__main__':
    ...
    max_depths = [50, 100, 150, 200, 250, 500, 1000, 3000]
    for i in range(len(thresholds)):
        ...
        for j in range(len(max_depths)):
            ...
            try: 
                ...
                np.savetxt(os.path.join(save_dir, f"{config['parameters']['detector']}_threshold{config['parameters']['threshold']}_maxdepth{config['parameters']['max_depth']}_rectify{config['parameters']['detector']}.txt"), positions, fmt="%.16f")
